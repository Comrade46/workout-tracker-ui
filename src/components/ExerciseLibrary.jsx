...
function ExerciseLibrary() {
    ...
    const loadExercises = async () => {
        try {
            ...
            console.error(
                "Error loading exercise library:",
                requestError
            );
    ...
    const customCount = exercises.filter(
    ...
    const handleSubmit = async (event) => {
        ...
        if (
            ...
            setActionError(
                "Please fill in all required exercise fields."
            );
            return;
        }
        ...
        try {
            ...
            const payload = {
                ...
                durationSeconds: Math.max(
                    1,
                    Number(form.durationSeconds) || 1
                ),
                restSeconds: Math.max(
                    0,
                    Number(form.restSeconds) || 0
                )
            };
        ...
        return (
            <div style={styles.center}>
                ...
                <p style={styles.loadingText}>
                    Preparing your workout toolbox.
                </p>
            </div>
        );
    }
                ...
                <section style={styles.hero}>
                    <div>
                        ...
                        <p style={styles.subtitle}>
                            Explore exercises, edit
                            existing movements, create
                            your own exercises, and
                            manage your workout toolbox.
                        </p>
                    </div>
                ...
                >
                    ...
                    >
                        ...
                        >
                            ...
                            <p
                                style={
                                    styles.timerEditorText
                                }
                            >
                                Set the time you want
                                this exercise to use
                                in your workout
                                experience.
                            </p>
                        ...
                        {/* ALL EXERCISES CAN NOW BE EDITED/DELETED */}
...
const styles = {
    page: {
        ...
        background:
            "linear-gradient(135deg, #111318 0%, #181b22 55%, #101216 100%)",
        color: "#f8fafc",
    ...
    categoryIcon: {
        ...
        fontSize: "25px",
        background:
            "linear-gradient(135deg, rgba(251,191,36,0.2), rgba(245,158,11,0.06))",
        border:
